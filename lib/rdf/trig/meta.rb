...
module RDF::TriG::Meta
  ...
  BRANCH = {
    ...
    :_graph_1 => {
      :ANON => [:graphName, "{", :_graph_3, "}"],
      :BLANK_NODE_LABEL => [:graphName, "{", :_graph_3, "}"],
      :IRIREF => [:graphName, "{", :_graph_3, "}"],
      :PNAME_LN => [:graphName, "{", :_graph_3, "}"],
      :PNAME_NS => [:graphName, "{", :_graph_3, "}"],
    },
    :_graph_2 => {
      "{" => ["{", :_graph_6, "}"],
    },
