...
module RDF::TriG::Meta
  ...
  BRANCH = {
    ...
    :_tripleOrBareGraph_1 => {
      :ANON => [:graphName, :_tripleOrBareGraph_4],
      :BLANK_NODE_LABEL => [:graphName, :_tripleOrBareGraph_4],
      :IRIREF => [:graphName, :_tripleOrBareGraph_4],
      :PNAME_LN => [:graphName, :_tripleOrBareGraph_4],
      :PNAME_NS => [:graphName, :_tripleOrBareGraph_4],
    },
    :_tripleOrBareGraph_2 => {
      "[" => [:graphName1, :_tripleOrBareGraph_6],
    },
    :_tripleOrBareGraph_3 => {
      "(" => [:collection, :PropertyListNotEmpty, "."],
    },
    :_tripleOrBareGraph_4 => {
      :IRIREF => [:_tripleOrBareGraph_5],
      :PNAME_LN => [:_tripleOrBareGraph_5],
      :PNAME_NS => [:_tripleOrBareGraph_5],
      "a" => [:_tripleOrBareGraph_5],
      "{" => [:wrappedDefault],
    },
